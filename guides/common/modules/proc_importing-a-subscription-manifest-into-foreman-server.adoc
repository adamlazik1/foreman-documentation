...
[NOTE]
====
If Simple Content Access (SCA) is enabled on your organization and you import a non-SCA manifest, it will show as SCA.
====
...
. In the {ProjectWebUI}, navigate to *Content* > *Subscriptions* and click *Import a Manifest*.
